...
export async function GET(
  ...
  try {
    ...
    const activeCustomersChangePct =
      prevActiveCustomers === 0
        ? 0
        : Number((((activeCustomers - prevActiveCustomers) / prevActiveCustomers) * 100).toFixed(1));
